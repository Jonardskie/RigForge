...
let memBuilds = [...initialBuilds];
let memLogs = [...initialActivityLogs];
// Helper: Run Server-Side Compatibility & Risk Scoring
function evaluateBuildRisk(compList, requestedPsuWatts) {
    const reasons = [];
    let riskScore = 'LOW';
